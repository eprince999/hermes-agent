"""LeLamp local agent — Stage 3 music folder, no OpenAI, no LiveKit.
...
AGENT_STAGE = 3
AGENT_LABEL = "vosk listen + music folder + viz"
...
HELP_TEXT = """本地台灯 Stage 3（无 OpenAI）
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="LeLamp local Stage 3 + music folder (no OpenAI)")
    ...
    parser.add_argument("--listen", action="store_true", help="Stage 3: Vosk keywords plus music folder")
